...
public class Human implements Actor {
    ...
    public Human(String name, long maxRunLength, long maxJumpHeight) {
        this.name = name;
    ...
    public boolean run(long length) {
        ...
        System.out.println("Человек: " + name + ".run(" + length + ")-> результат:" + result);
        return result;
    }
    ...
    public boolean jump(long height) {
        ...
        System.out.println("Человек: " + name + ".jump(" + height + ")-> результат:" + result);
        return result;
    }
}
